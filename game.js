...
function setupInputs() {
    ...
    // Left Zone
    leftZone.addEventListener('touchstart', handleMoveLeft);
    leftZone.addEventListener('mousedown', handleMoveLeft);
    leftZone.addEventListener('touchend', handleStopMove);
    leftZone.addEventListener('mouseup', handleStopMove);
    leftZone.addEventListener('mouseleave', handleStopMove);

    // Right Zone
    rightZone.addEventListener('touchstart', handleMoveRight);
    rightZone.addEventListener('mousedown', handleMoveRight);
    rightZone.addEventListener('touchend', handleStopMove);
    rightZone.addEventListener('mouseup', handleStopMove);
    rightZone.addEventListener('mouseleave', handleStopMove);
